package idea.demasseb.springbootvuejs.controller;

import idea.demasseb.springbootvuejs.SpringBootVuejsApplication;
...
public class BackendControllerTest {
    ...
    public void addNewUserAndRetrieveItBack() {
        User brian = new User("Brian", "DeMasse");

        Long userId =
            given()
                .pathParam("firstName", "Brian")
                .pathParam("lastName", "DeMasse")
            .when()
        ...
        assertThat(responseUser.getFirstName(), is("Brian"));
        assertThat(responseUser.getLastName(), is("DeMasse"));
    }
